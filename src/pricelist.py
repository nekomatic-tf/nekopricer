...
class Pricelist:
    ...
    def __init__(
        ...
        set_interval(self.get_external_pricelist, config["intervals"]["pricelist"]) # Every 5 minutes
        set_interval(self.get_key_price, config["intervals"]["pricelist"]) # 5 Minutes
    ...
    def get_key_price(self):
        ...
        self.logger.info("Fetched key price.")
        self.socket_io.emit("price", self.key_price) # Couldn't think of a better place to put this tbh
